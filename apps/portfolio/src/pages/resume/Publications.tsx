...
export const Publications = () => (
	<Flex direction="column" data-id="Publications-flex-1-01f858">
		<Text variant="title" data-id="Publications-text-1-fcf4b6">
			Publications
		</Text>
		<ResumeDivider />
		...
		<Anchor
			...
			w="fit-content"
		>
			<Text mr="$2" data-id="Publications-text-2-e4579c">
				Versioned web components and micro front-ends &ndash; June 2025
			</Text>
